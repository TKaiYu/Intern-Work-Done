var webserver = {
    ...
    scale_changed: function(e) {
        ...
        /* make a XMLHTTP server */
        webserver.requestDataFlag = 0;
        var xhttpScale = new XMLHttpRequest(); //objects used to interact with servers. retrieve data from a url without full page refresh
