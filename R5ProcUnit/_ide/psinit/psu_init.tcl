...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070100 0x7F3F7F3F 0x100F2110
    ...
    mask_write 0XFD070184 0x3FFFFFFF 0x02017D77
    ...
    mask_write 0XFD080018 0xFFFFFFFF 0x00F0EFD0
    ...
    mask_write 0XFD080024 0xFFFFFFFF 0x010100F4
		...
		# PLL Power-Down Time
		# PSU_DDR_PHY_PTR0_TPLLPD                                                         0x1f4

		# PLL Gear Shift Time
		# PSU_DDR_PHY_PTR0_TPLLGS                                                         0x7d0

		# PHY Reset Time
		# PSU_DDR_PHY_PTR0_TPHYRST                                                        0x10

		# PHY Timing Register 0
		#(OFFSET, MASK, VALUE)      (0XFD080040, 0xFFFFFFFFU ,0x3E81F410U)  */
    mask_write 0XFD080040 0xFFFFFFFF 0x3E81F410
		# Register : PTR1 @ 0XFD080044</p>

		# PLL Lock Time
		# PSU_DDR_PHY_PTR1_TPLLLOCK                                                       0xc350

		# Reserved. Returns zeroes on reads.
		# PSU_DDR_PHY_PTR1_RESERVED_15_13                                                 0x0

		# PLL Reset Time
		# PSU_DDR_PHY_PTR1_TPLLRST                                                        0x1194

		# PHY Timing Register 1
		#(OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0xC3501194U)  */
    mask_write 0XFD080044 0xFFFFFFFF 0xC3501194
    ...
    mask_write 0XFD080680 0xFFFFFFFF 0x008A6A58
...
mwr -force  0xFD080018 0x00F01CE7
...
mwr -force  0xFD080018 0x00F1109F
